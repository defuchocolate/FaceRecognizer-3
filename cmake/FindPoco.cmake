...
#
set (Poco_LIBRARY_SUFFIX "" CACHE STRING "Library suffix (ex. md)")
...
IF(Poco_INCLUDE_DIR)
  ...
  IF(NOT Poco_LIBRARY_DIR)
    ...
    FIND_LIBRARY(Poco_FOUNDATION_LIB NAMES PocoFoundation${Poco_LIBRARY_SUFFIX} PocoFoundation${Poco_LIBRARY_SUFFIX}d  PATH_SUFFIXES ${SUFFIX_FOR_LIBRARY_PATH} PATHS
...
#      SET(Comp_List "Foundation${Poco_LIBRARY_SUFFIX}${DBG}")
	   SET(Comp_List "")
      FOREACH(COMPONENT ${Poco_FIND_COMPONENTS})
	FIND_LIBRARY(Poco_LIB${COMPONENT} NAMES Poco${COMPONENT}${Poco_LIBRARY_SUFFIX} Poco${COMPONENT}${Poco_LIBRARY_SUFFIX}d ${COMPONENT}${Poco_LIBRARY_SUFFIX} PATHS ${Poco_LIBRARY_DIR})
	IF (Poco_LIB${COMPONENT})
	  IF (${COMPONENT} STREQUAL CppUnit OR ${COMPONENT} STREQUAL WinTestRunner)
		SET (COMPONENT_LIBNAME "${COMPONENT}")
	  ELSE()
		SET (COMPONENT_LIBNAME "Poco${COMPONENT}")
	  ENDIF()
	  IF (${COMPONENT} STREQUAL DataSQLite)
		LIST(APPEND Poco_INCLUDE_DIRS "${Poco_INCLUDE_DIR}/Data/SQLite/include")
	  ELSEIF (${COMPONENT} STREQUAL WinTestRunner)
		LIST(APPEND Poco_INCLUDE_DIRS "${Poco_INCLUDE_DIR}/CppUnit/WinTestRunner/include")
		LIST(APPEND Poco_LIBRARIES "winmm")
	  ELSE()
		LIST(APPEND Poco_INCLUDE_DIRS "${Poco_INCLUDE_DIR}/${COMPONENT}/include")
	  ENDIF()
	  LIST(APPEND Poco_LIBRARIES "optimized" "${COMPONENT_LIBNAME}${Poco_LIBRARY_SUFFIX}" "debug" "${COMPONENT_LIBNAME}${Poco_LIBRARY_SUFFIX}d")
	  LIST(APPEND Comp_List "${COMPONENT}${Poco_LIBRARY_SUFFIX}${DBG}")
	ENDIF(Poco_LIB${COMPONENT})
